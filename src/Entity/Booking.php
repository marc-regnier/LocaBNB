...
class Booking
{
    ...
    /**
     * Permet récupérer un tableau des journées qui correspondent à ma réservation
     *
     * @return array Tableau objets DateTime représentant les jours de la réservation
     */
