...
class Ad
{
    ...
    /**
     * Permet obtenir un tableau jour indisponible
     * 
     *
     * @return array Un tableau objet Datetime jours occupations
     */
    public function getNotAvailableDays(){
        $notAvailableDays = [];

        foreach($this->bookings as $booking){
            //calculer les jours entre date arrivee et départ
            $resultat = range (
